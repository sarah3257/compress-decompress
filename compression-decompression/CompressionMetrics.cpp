...
void CompressionMetrics::HuffmanCompression(const std::string& fileName) {

}

void CompressionMetrics::LZ77Compression() {
...
int RunGraphWindow(HINSTANCE hInstance, int nCmdShow) {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    return RunGraphWindow(hInstance, nCmdShow);
}
